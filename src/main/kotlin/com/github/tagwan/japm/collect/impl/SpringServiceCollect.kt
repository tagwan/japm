...
class SpringServiceCollect : AbstractCollect(), ICollect {
    companion object {
        ...
        init {
            ...
            stringBuilder.append("com.dagwan.collect.SpringServiceCollect instance = ")
            stringBuilder.append("com.dagwan.collect.SpringServiceCollect.INSTANCE;\r\n")
            stringBuilder.append("com.dagwan.AbstractCollect.Statistics statics = instance.begin(\"%s\", \"%s\");")
